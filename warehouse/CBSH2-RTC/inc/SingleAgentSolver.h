...
public:
	...
	{
		// std::cout << "get_DH_heuristic(from, to):" << get_DH_heuristic(from, to) << "  instance.getManhattanDistance(from, to):" << instance.getManhattanDistance(from, to) << endl;
	...
	{
		compute_heuristics();
		// std::cout << "Initialize SingleAgentSolver finish......" << std::endl;
	}
